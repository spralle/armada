import { createInitialShellContextState, registerTab, readGroupLaneForTab, readGlobalLane } from "../context-state.js";
import { createRuntimeEventHandlers } from "./runtime-event-handlers.js";
import type { ShellRuntime } from "../app/types.js";
import type { SpecHarness } from "../context-state.spec-harness.js";

function createRuntime(): ShellRuntime {
  const initialState = registerTab(createInitialShellContextState({
    initialTabId: "tab-a",
