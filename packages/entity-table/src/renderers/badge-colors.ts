...
const COLOR_PALETTE: readonly BadgeColorStyle[] = [
  { backgroundColor: 'oklch(0.55 0.18 250 / 0.15)', color: 'oklch(0.78 0.15 250)', borderColor: 'oklch(0.55 0.18 250 / 0.3)' },   // blue
  { backgroundColor: 'oklch(0.55 0.17 160 / 0.15)', color: 'oklch(0.78 0.14 160)', borderColor: 'oklch(0.55 0.17 160 / 0.3)' },   // emerald
  { backgroundColor: 'oklch(0.60 0.15 85 / 0.15)',  color: 'oklch(0.82 0.12 85)',  borderColor: 'oklch(0.60 0.15 85 / 0.3)' },    // amber
  { backgroundColor: 'oklch(0.55 0.18 300 / 0.15)', color: 'oklch(0.78 0.15 300)', borderColor: 'oklch(0.55 0.18 300 / 0.3)' },   // violet
  { backgroundColor: 'oklch(0.55 0.20 25 / 0.15)',  color: 'oklch(0.78 0.16 25)',  borderColor: 'oklch(0.55 0.20 25 / 0.3)' },    // rose
  { backgroundColor: 'oklch(0.55 0.12 200 / 0.15)', color: 'oklch(0.78 0.10 200)', borderColor: 'oklch(0.55 0.12 200 / 0.3)' },   // cyan
  { backgroundColor: 'oklch(0.60 0.16 55 / 0.15)',  color: 'oklch(0.82 0.13 55)',  borderColor: 'oklch(0.60 0.16 55 / 0.3)' },    // orange
  { backgroundColor: 'oklch(0.55 0.18 330 / 0.15)', color: 'oklch(0.78 0.15 330)', borderColor: 'oklch(0.55 0.18 330 / 0.3)' },   // fuchsia
];
