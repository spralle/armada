...
Escalation triggers (any one means stop and hand off):
- Scope expands beyond one bead or one cohesive change.
...
- If escalation trigger appears, stop and recommend Builder route to full chain.
