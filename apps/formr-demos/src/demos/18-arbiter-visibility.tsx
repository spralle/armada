...
const arbiterRules = [
  { name: 'showUSState', when: { country: 'US' }, then: [{ $set: { '$ui.showState': true, '$ui.showProvince': false } }] },
  { name: 'showCAProvince', when: { country: 'CA' }, then: [{ $set: { '$ui.showState': false, '$ui.showProvince': true } }] },
  { name: 'hideRegional', when: { country: { $nin: ['US', 'CA'] } }, then: [{ $set: { '$ui.showState': false, '$ui.showProvince': false } }] },
] as const;
  ...
  return (
    ...
    >
      <Card className="border-border">
        <CardHeader><CardTitle className="text-foreground">Country Selector</CardTitle></CardHeader>
