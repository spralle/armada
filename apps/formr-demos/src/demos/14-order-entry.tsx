...
const schema = {
  ...
  properties: {
    ...
    paymentMethod: { type: 'string', title: 'Payment Method', enum: ['Credit Card', 'Wire Transfer', 'Purchase Order', 'Net 30', 'Net 60'] },
    ...
    notes: { type: 'string', title: 'Order Notes', 'x-formr': { widget: 'textarea' }, description: 'Internal notes for this order' },
...
const layout = {
  type: 'group', id: 'root', children: [
    { type: 'section', id: 'header', props: { title: 'Order Header', columns: 2 }, children: [
    ...
    { type: 'section', id: 'customer', props: { title: 'Customer', columns: 2 }, children: [
      { type: 'field', id: 'f-name', path: 'customerName' },
      { type: 'field', id: 'f-email', path: 'customerEmail' },
    ]},
    { type: 'section', id: 'payment', props: { title: 'Payment & Pricing', columns: 2 }, children: [
    ...
    { type: 'section', id: 'delivery', props: { title: 'Delivery Options', columns: 2 }, children: [
      { type: 'field', id: 'f-signature', path: 'requiresSignature' },
    ]},
    { type: 'section', id: 'notes', props: { title: 'Notes' }, children: [
      { type: 'field', id: 'f-notes', path: 'notes' },
    ]},
  ],
} as const;
