...
const schema = {
  ...
  properties: {
    ...
    department: { type: 'string', title: 'Department', enum: ['Engineering', 'Product', 'Marketing', 'Sales', 'HR', 'Finance', 'Legal', 'Operations'] },
...
const layout = {
  type: 'group', id: 'root', children: [
    { type: 'section', id: 'personal', props: { title: 'Personal Information', columns: 2 }, children: [
    ...
    { type: 'section', id: 'work', props: { title: 'Work Details', columns: 2 }, children: [
      { type: 'field', id: 'f-role', path: 'role' },
      { type: 'field', id: 'f-department', path: 'department' },
    ]},
    { type: 'section', id: 'preferences', props: { title: 'Preferences' }, children: [
