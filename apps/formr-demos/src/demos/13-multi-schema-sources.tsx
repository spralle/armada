...
const explicitSchema = {
  ...
  properties: {
    name: { type: 'string', title: 'Full Name', description: 'Your complete name as it appears on official documents', minLength: 2, maxLength: 100 },
    ...
    role: { type: 'string', title: 'User Role', enum: ['Admin', 'User', 'Guest'], description: 'Access level in the system' },
