...
const orders: Order[] = [
  { id: "ORD-1001", customer: "Alice Johnson", total: 234.5, status: "delivered", date: new Date("2024-08-15") },
  { id: "ORD-1002", customer: "Bob Martinez", total: 89.99, status: "shipped", date: new Date("2024-09-02") },
  { id: "ORD-1003", customer: "Carol Chen", total: 1250.0, status: "processing", date: new Date("2024-09-10") },
  { id: "ORD-1004", customer: "David Kim", total: 45.0, status: "pending", date: new Date("2024-09-12") },
  { id: "ORD-1005", customer: "Eva Rossi", total: 678.25, status: "cancelled", date: new Date("2024-08-28") },
  { id: "ORD-1006", customer: "Frank Okafor", total: 320.0, status: "delivered", date: new Date("2024-07-20") },
  { id: "ORD-1007", customer: "Grace Liu", total: 155.75, status: "pending", date: new Date("2024-09-14") },
  { id: "ORD-1008", customer: "Hiro Tanaka", total: 890.0, status: "shipped", date: new Date("2024-09-08") },
  { id: "ORD-1009", customer: "Isla Patel", total: 42.5, status: "processing", date: new Date("2024-09-13") },
  { id: "ORD-1010", customer: "James Wright", total: 1100.0, status: "delivered", date: new Date("2024-08-01") },
];
...
const rowOperations: EntityOperation<Order>[] = [
  ...
  },
  {
    ...
    handler: ({ entity }) => alert(`Edit order ${entity?.id}`),
    when: ({ entity }) => entity?.status !== "cancelled",
  },
  {
    id: "delete",
    ...
    variant: "destructive",
    handler: ({ entity }) => alert(`Delete order ${entity?.id}`),
    when: ({ entity }) => entity?.status === "pending",
  },
];
...
const batchOperations: EntityOperation<Order>[] = [
  {
    ...
    handler: ({ selection }) => alert(`Export ${selection?.length} orders`),
  },
  {
    id: "bulk-delete",
    label: "Delete Selected",
    variant: "destructive",
    handler: ({ selection }) => alert(`Delete ${selection?.length} orders`),
  },
];
