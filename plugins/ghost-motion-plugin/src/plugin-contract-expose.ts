import type { PluginContract, GhostApi, ActivationContext, HookService, ElementTransitionHook } from "@ghost-shell/contracts";
import { HOOK_REGISTRY_SERVICE_ID, ELEMENT_TRANSITION_HOOK_ID } from "@ghost-shell/contracts";
